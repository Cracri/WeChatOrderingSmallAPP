...
<form class="layui-form layui-form-pane">
		<div class="layui-form-item">
		    ...
		    <div class="layui-input-inline">
		      	<input type="text" name="productName" id="productName" autocomplete="off" class="layui-input" value="${product.productName }">
		    </div>
	    	</div>
  		</div>
  		...
  		<div class="layui-form-item">
	    	...
	    	<div class="layui-input-inline">
	      		<input type="text" name="productId" id="productId" autocomplete="off" class="layui-input" disabled="disabled" value="${product.productId }">
    	...
    	<label class="layui-form-label">菜品价格</label>
	    	<div class="layui-input-inline">
	      		<input type="text" name="productPrice" id="productPrice" autocomplete="off" class="layui-input" value="${product.productPrice }">
	    	</div>
  		</div>
    	...
    	<label class="layui-form-label">菜品折扣</label>
	    	<div class="layui-input-inline">
	      		<input type="text" name="discount" id="discount"  autocomplete="off" class="layui-input" value="${product.discount }">
	    	</div>
  		</div>
	      ...
	      <div class="layui-input-inline">
	        <select name="type" id="type" disabled="disabled">
	          ...
	          <option value="1" ${product.type=='1'?'selected':'' }>川菜</option>
	          <option value="2" ${product.type=='2'?'selected':'' }>粤菜</option>
	          <option value="3" ${product.type=='3'?'selected':'' }>苏菜</option>
	          <option value="4" ${product.type=='4'?'selected':'' }>鲁菜</option>
	        </select>
	      </div>
	    </div>
	    ...
	    <div class="layui-upload" style="margin-top:20px;">
		  ...
		  <div class="layui-upload-list">
		    ...
		    <!-- 图片上传f -->
    		<input type="hidden" name="productPic" id="productPic" value="${product.productPic }"  />
    		<!-- id -->
		...
		<div class="layui-form-item" >
		    <div class="layui-input-block">
		      <button class="layui-btn" lay-submit="" lay-filter="demo1" style="margin-left:200px;">确认修改</button>
...
layui.use(['form', 'layedit', 'laydate','upload'], function(){
	  ...
	  if(productPic){
		  $("#demo1").attr("src","../greensImages/"+productPic);
	  }
	  ...
	  var uploadInst = upload.render({
		...
		//监听提交
	  	form.on('submit(demo1)', function(data){
			...
			//提交信息
			$.ajax({
	  	    	  url:"${pageContext.request.contextPath}/greens/updateProductInfo.do",
